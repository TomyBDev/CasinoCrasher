...
UE_DEFINE_GAMEPLAY_TAG(TAG_Player_Action_Bombing, "Player.Action.Bombing");
UE_DEFINE_GAMEPLAY_TAG(TAG_Player_Action_Sprinting, "Player.Action.Springing");
UE_DEFINE_GAMEPLAY_TAG(TAG_Player_Action_Jumping, "Player.Action.Jumping");